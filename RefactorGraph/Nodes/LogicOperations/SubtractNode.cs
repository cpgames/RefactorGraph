...
{
    [Node]
    [RefactorNode(RefactorNodeGroup.LogicOperations, RefactorNodeType.Subtract)]
    public class SubtractNode : RefactorNodeBase
    {
        #region Fields
        ...
        #region Constructors
        public SubtractNode(Guid guid, FlowChart flowChart) : base(guid, flowChart)
        {
            Header = "A - B";
        }
        #endregion
