...
namespace gma.System.Windows
{
    ...
    public class UserActivityHook
    {
        ...
        public UserActivityHook(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            ...
            OnMouseActivity += UserActivityHook_OnMouseActivity;
        }

        private void UserActivityHook_OnMouseActivity(object sender, MouseEventArgs e)
        {
            mouseX = e.X;
            mouseY = e.Y;
        }
        ...
        private class MouseLLHookStruct
        {
            ...
            /// If the message is WM_XBUTTONDOWN, WM_XBUTTONUP, WM_XBUTTONDBLCLK, WM_NCXBUTTONDOWN, WM_NCXBUTTONUP,
            /// or WM_NCXBUTTONDBLCLK, the high-order word specifies which X button was pressed or released,
            /// and the low-order word is reserved. This value can be one or more of the following values. Otherwise, mouseData is not
            /// used.
            /// XBUTTON1
